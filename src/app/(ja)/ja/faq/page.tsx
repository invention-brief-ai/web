...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "主に3点です。第一に「構造」:出力は、専門家が実際に見たい形式のブリーフであり、国別の準備ガイドと連動しています。第二に「境界線」:本ツールは準備支援に徹し、法的助言や特許性の判断に踏み込まない設計です。第三に「情報の扱い」:このプロトタイプは入力内容を一切収集せず(収集するのはCookie不使用の集計訪問統計のみ)、公開予定のブリーフ作成機能も、アイデアをサーバーに送らずお使いの端末内で処理する方向で設計を進めています。",
  },
  {
    question: "このサイトにアイデアを入力しても安全ですか?",
    answer:
      "現在のプロトタイプには、データを送信・保存するフォームはありません。サイト上のどこに入力しても、内容が送信・保存されることはありません。収集しているのは、匿名の集計ページビュー統計のみです(Cookie不使用・個人の追跡なし。詳細はプライバシーページへ)。それでも、適切な利用規約・プライバシー・秘密保持体制が整うまでは、本サービスに限らずどのようなサービスにも、未公開の発明内容や機密情報を入力しないでください。未公開の詳細は、自分で選んだ専門家にだけ伝えるのが安全です。",
  },
  {
    question: "料金はかかりますか?",
    answer:
