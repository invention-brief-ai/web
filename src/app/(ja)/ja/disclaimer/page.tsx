    ...
    <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
      ...
      <div className="mt-10 space-y-10">
        ...
        <section>
          ...
          <p className="mt-3 leading-7 text-slate-600">
            ローカルワークスペースは下書きをお使いの端末内に保存するため、ご自身のプライベートなメモとして利用できます。一方で、秘密保持の枠組みがない経路、たとえばβ版案内フォームや連絡先メールなどを通じて、機密の発明内容を端末の外に送らないでください。本サービスの利用によって、秘密保持の関係や、弁理士・弁護士との委任関係が生じることはありません。また、多くの国では出願前の公開がその後の選択肢に影響し得るため、公開に関する疑問はできるだけ早く資格を有する専門家にご相談ください。
          </p>
        </section>
