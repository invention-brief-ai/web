      ...
      <div className="mt-10 space-y-10">
        <section>
          ...
          <p className="mt-3 leading-7 text-slate-600">
            Invention Brief
            AIは、発明者が弁理士などの専門家に相談する前に、自分のアイデアを整理するための相談準備ツールです。現在は早期段階のプロジェクトです。このサイトは日英二言語の情報ページと、今すぐ使えるローカルワークスペース(アカウント不要・AIなしで端末内で動作する無料ツール)で構成されています。AIによる補助は今後の予定です。
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-6 leading-7 text-slate-600">
            <li>
              アカウント、決済、サーバー側での入力内容の収集はありません。ワークスペースの下書きは端末内にとどまり、サイトが受け取るのはCookie不使用の匿名訪問統計のみです
            </li>
            <li>
              ローカルワークスペースは今すぐ利用できます(端末内・AIなし)。β版案内の登録やAI機能はまだ稼働していません
            </li>
            <li>
